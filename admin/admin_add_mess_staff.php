...
<body>
   ...
   if(isset($_POST['submit']))
   {
   	...
   	$hall=$_POST['assigned_hall'];

   	
   	$qry= "INSERT INTO staff('AdminID','Name','MessID','Password','Assigned_Hall') VALUES ('$admid','$name','$id','$password','$hall')";
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post">
				<span class="contact100-form-title">
					...
					<input class="input100"  type="number" name="admid" placeholder="Admin Id">
					<label class="label-input100" for="ID">
                ...
                <div class="wrap-input100 validate-input" >
					<input class="input100"  type="number" name="assigned_hall" placeholder="Assigned Hall">
					<label class="label-input100" for="assigned_hall">
