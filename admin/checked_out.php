...
<html lang="en">
<head>
	<title>Admin| Checked-Out Students </title>
	<meta charset="UTF-8">
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="admin login.php">Logout <span class="glyphicon glyphicon-log-in" aria-hidden="true"></span></a></li>
        ...
        <div class="card-body">
            ...
            <span class="contact100-form-title">
                ...
                <table class="table table-bordered table-dark">
                      ...
                      <tbody>
    <?php
    $sqlget  = "SELECT * FROM students WHERE Status='Out'";
