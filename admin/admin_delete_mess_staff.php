...
<body>
    ...
    if(isset($_POST['submit']))
    {
      ...
      $query = "SELECT * FROM staff WHERE MessID='$id'";
      $result = mysqli_query($connect,$query);
        ...
        {
          echo"Valid ID";
          $qry = "DELETE FROM staff WHERE MessID ='$id'";
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form"  method="post">
                ...
                <div class="wrap-input100 validate-input" data-validate="Mess ID is required">
					<input class="input100" id="ID" type="number" name="id" placeholder="ID">
