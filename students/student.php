      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="student_change_pwd.php">Change Password</a></li>
              ...
              <div class="panel-body">
                <div class="col-md-3">
                  <div class="well dash-box">
                    ...
                    <h4> <a href="view_mess_menu.php">View Mess Menu</a> </h4>
                  </div>
                  </div>
                  <div class="col-md-3">
                  <div class="well dash-box">
                    <h2><span class="glyphicon glyphicon-stats" aria-hidden="true"></span></h2>
                    <h4><a href="view_bill.php">View Mess Bill</a></h4>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="well dash-box">
                    <h2><span class="glyphicon glyphicon-comment" aria-hidden="true"></span></h2>
                    <h4><a href="complaint.php">File a Complaint or Suggestion</a></h4>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="well dash-box">
                    <h2><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span></h2>
                    <h4><a href="check_in_check_out.php">Check-In or Check-Out</a></h4>
                  </div>
                </div>
