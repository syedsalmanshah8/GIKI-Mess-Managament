...
<body>
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post">
				<span class="contact100-form-title">
					Update Existing Student Mess Bill
				</span>

                
                <div class="wrap-input100 validate-input" data-validate="Reg No is required">
					<input class="input100"  type="number" name="regno" placeholder="Reg No">
					<label class="label-input100" >
						<span class="lnr lnr-user"></span>
					</label>
				</div>
                
                <div class="wrap-input100 validate-input" data-validate="Bill is required">
					<input class="input100"  type="number" name="bill" placeholder="Bill">
    ...
    if(isset($_POST['submit']))
    {
      ...
      $query = " UPDATE mess_bill  SET Monthly_Bill='$bill' WHERE Reg_Number='$regno' ";
