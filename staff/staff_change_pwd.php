...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-default">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="staff.php">GIKI Mess</a>
        </div>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="text-center"> Staff <small>Account Password Renew</small></h1>
          </div>
        </div>
      </div>
    </header> 
  ...
  <?php
    if(isset($_POST['submit']))
    {
      ...
      $query = " UPDATE staff SET Password='$new_pwd' WHERE MessID='$id' AND Password='$pwd' " ;
